...
- **[ARCHITECTURE_STATUS.md](./ARCHITECTURE_STATUS.md)** - Current architecture status and implementation state
- **[CONTROLLERS_VS_ORPC.md](./CONTROLLERS_VS_ORPC.md)** - Comparison and guidelines for controllers vs oRPC
